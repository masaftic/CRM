...
{
    public static async Task<Results<Ok<PipelineResponse>, NotFound, BadRequest<string>>> Handle(string pipelineId, [FromBody] AddStageRequest request, [FromServices] ISalesUnitOfWork uow)
    {
